...
public class ArrayListNotes
{
    public static void main(String[] args)
    {
         ...
         *      cannot be specified as the type of elements in a
            ...
            int size, int range)
    {
        ...
        for(int i = 0; i < size; i++)
        {
            ...
            /*
             * The add method add the specified object to the end
             *      of the list.
             *   
             *  Autoboxing:
    ...
    public static void removeEvens(ArrayList<Integer> list)
    {
        ...
        for(int i = 0; i < list.size(); i++)
        {
            ...
            {
                /*
                 * The remove method deletes thje element at the
                 *      specified index from the list. All
